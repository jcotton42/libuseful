...
project = 'libuseful'
copyright = 'Fox Wilson, Joshua Cotton 2013. All files licensed under the GNU GPL, version 3'
...
exclude_patterns = ['_build', '**/__main__.py']
...
htmlhelp_basename = 'libusefuldoc'
...
epub_author = 'Fox Wilson, Joshua Cotton'
epub_publisher = 'Fox Wilson, Joshua Cotton'
epub_copyright = '2013, Authors'
